...
int main(int argc, char **argv){
    ...
    // particle properties
    double sigma = 1.0;
    double dipole_head = 112.39;
    double dipole_tail = -53.39;
    double zeta_r = 3.0;
    double zeta_t = 9.0;
    double v_0;
    ...
    int nx = 50;                                                  // number of particles initially placed along x-axis
    ...
    sprintf(fn1,"dipole_N2500_v0.xyz");
    fp2 = fopen(fn1,"w");
    ...
    for(times=0;times<170.0;times+=h1){
